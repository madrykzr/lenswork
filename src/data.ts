...
export const BENTO_CHIPS: PhotographySample[] = [
  {
    ...
    imageUrl: '/images/portrait_bento_1.jpg',
  ...
  },
  {
    ...
    imageUrl: '/images/architecture_bento_2.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=800&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/product_bento_4.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=800&auto=format&fit=crop',
    gridSpan: 'md:col-span-1 md:row-span-1',
    rotation: 'rotate-3',
  ...
  },
  {
    ...
    imageUrl: '/images/portrait_bento_5.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=800&auto=format&fit=crop',
    gridSpan: 'md:col-span-1 md:row-span-1',
    rotation: '-rotate-1',
...
export const SIGNATURE_IMAGE = '/images/signature_hero.jpg';
export const SIGNATURE_FALLBACK = 'https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=1500&auto=format&fit=crop';
...
export const SCATTERED_PHOTOS: ScatteredPhoto[] = [
  {
    ...
    imageUrl: '/images/scattered_1.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1511919884226-fd3cad34687c?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/scattered_2.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/scattered_3.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1500627869374-13cd993b1115?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/scattered_4.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?q=80&w=600&auto=format&fit=crop',
...
export const PORTFOLIO_SHOWCASE: PortfolioGridItem[] = [
  {
    ...
    imageUrl: '/images/port_1.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1569173112611-52a7cd38bea9?q=80&w=600&auto=format&fit=crop',
    spec: '45 min / Studio',
  ...
  },
  {
    ...
    imageUrl: '/images/port_2.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1504198453319-5ce911bafcde?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/port_3.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/port_4.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/port_5.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=600&auto=format&fit=crop',
  ...
  },
  {
    ...
    imageUrl: '/images/port_6.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1621600411688-4be93cd68504?q=80&w=600&auto=format&fit=crop',
    spec: '75 min / Studio',
...
export const PAST_PROJECTS: PastProject[] = [
  {
    ...
    imagesDelivered: 42,
    imageUrl: '/images/past_1.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=500&auto=format&fit=crop',
    year: '2025',
  },
  {
    id: 'past-2',
    ...
    location: 'London, UK',
    imagesDelivered: 18,
    imageUrl: '/images/past_2.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=500&auto=format&fit=crop',
    year: '2026',
  },
  {
    id: 'past-3',
    ...
    location: 'Oia, GR',
    imagesDelivered: 55,
    imageUrl: '/images/past_3.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=500&auto=format&fit=crop',
    year: '2026',
  },
  {
    id: 'past-4',
    ...
    location: 'Oslo, NO',
    imagesDelivered: 64,
    imageUrl: '/images/past_4.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=500&auto=format&fit=crop',
    year: '2025',
  },
];
